...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <h1 class="logo"><a href="index.html">Viaje Turista</a></h1>
        ...
        <div class="hero-container">
            <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <!-- Slide 1 -->
                    <div class="carousel-item active" style="background-image: url(img/slide/panchimalco-1.jpg);">
                        <div class="carousel-container">
                            <div class="carousel-content">
                                <h2 class="animate__animated animate__fadeInDown">Descubre Panchimalco</h2>
                                <p class="animate__animated animate__fadeInUp">un pueblo con encanto propio situado a
                                    pocos kilómetros del corazón de la capital del país. Aquí encontrarás un destino
                                    perfecto para disfrutar de una escapada tranquila y sumergirte en la cultura y
                                    tradiciones de El Salvador. </p>
                    ...
                    <!-- Slide 2 -->
                    <div class="carousel-item" style="background-image: url(img/slide/panchimalco-2.jpg);">
                        <div class="carousel-container">
                            <div class="carousel-content">
                                <h2 class="animate__animated animate__fadeInDown">La Puerta del Diablo</h2>
                                <p class="animate__animated animate__fadeInUp">Es un lugar turístico popular en El
                                    Salvador, conocido por su impresionante vista panorámica del Valle de San Salvador.
                                    Este mirador natural se encuentra en las montañas que rodean la ciudad capital, y es
                                    una de las atracciones turísticas más famosas de la región.</p>
                    ...
                    <!-- Slide 3 -->
                    <div class="carousel-item" style="background-image: url(img/slide/panchimalco-4.png);">
                        <div class="carousel-container">
                            <div class="carousel-content">
                                <h2 class="animate__animated animate__fadeInDown">Tradicion Día de las Palmas</h2>
                                <p class="animate__animated animate__fadeInUp"> Los habitantes de Panchimalco crean
                                    hermosas alfombras de flores y hojas de palma en las calles del pueblo. Estas
                                    alfombras coloridas son diseñadas con habilidad,creatividad las cuales representan
                                    diferentes motivos religiosos y culturales.</p>
        ...
        <section id="services" class="services">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>Servicios</h2>
                    <p>Aqui estan algunos de los servicios que necesitaras para poder planificar tu viaje o si estas
                        planenado hacer un paso por Panchimalco
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 icon-box">
                        ...
                        <p class="description">todas las opciones de restaurantes y sitios para deleitar la comida de
                            panchimalco</p>
                    </div>
                    <div class="col-lg-4 col-md-6 icon-box">
                        <div class="icon"><i class="bi bi-card-checklist"></i></div>
                        <h4 class="title"><a href="">HOTELES</a></h4>
                        <p class="description">Si estas planificando tu viaje para quedarte a ver una actividad o evento
                            del pueblo puedes comtemplar una de estas opciones de hoteles</p>
                    </div>
                    <div class="col-lg-4 col-md-6 icon-box">
                        <div class="icon"><i class="bi bi-bar-chart"></i></div>
                        <h4 class="title"><a href="">EVENTOS </a></h4>
                        <p class="description">eventos y actividades que se realizan en panchimalco ya que es un pueblo
                            de muchas tradiciones hay muchas opciones para disfrutar de los eventso y tradiciones de
                            este pueblo</p>
                    </div>
                    <div class="col-lg-4 col-md-6 icon-box">
                        <div class="icon"><i class="bi bi-binoculars"></i></div>
                        <h4 class="title"><a href="">TRADICIONES DEL PUEBLO</a></h4>
                        <p class="description">Todas las tradiciones explicadas de este pueblo</p>
                    </div>
                    <div class="col-lg-4 col-md-6 icon-box">
                        <div class="icon"><i class="bi bi-brightness-high"></i></div>
                        <h4 class="title"><a href="">LUGARES TURISTICOS</a></h4>
                        <p class="description">Lugares que como turista puedes visitar y tomarte fotoso</p>
                    </div>
                </div>
        ...
        <section id="portfolio" class="portfolio">
            <div class="container">
                ...
                <div class="row portfolio-container">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app" 9>
